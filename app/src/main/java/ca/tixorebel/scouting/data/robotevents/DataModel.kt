...
data class MatchResult (val division: Int, val round: Int, val instance: Int, val matchnum: Int, val timescheduled: String, val red1: String, val red2: String, val red3: String, val redscore: Int, val redsit: String, val blue1: String, val blue2: String, val blue3: String, val bluescore: Int, val bluesit: String)
...
data class TournamentMetadata(var status: String, var open: Int?, var eventCode: String, var eventDate: String, var location: String, var type: String, var name: String)
